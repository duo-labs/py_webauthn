...
################
#
# Examples of using webauthn to verify responses
#
# Registrations and authentications are representative of WebAuthn credential responses
...
#
# `python -m examples.verification`
#
################
